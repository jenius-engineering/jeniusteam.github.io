---
layout: post
title: "Jenius Engineering weekly #28"
author: dedenf
tags:
    - newsletter
    - jenius
...
Welcome to Jenius Engineering newsletter #28, this newsletter published every tuesday-*ish*. please subscribe to our [newsletter](http://jenius.tech/newsletter).
...
- [Implications of Tech Stack Complexity for Executives](https://www.thoughtworks.com/insights/blog/implications-tech-stack-complexity-executives)
- [Refactoring with Composed Method pattern](https://www.agile-code.com/blog/refactoring-with-composed-method-pattern/)
- [How we design enterprise software](https://blog.usejournal.com/how-we-design-enterprise-software-916124fb73db)
- [Tutorial: Distributed Tracing in Ruby with OpenTracing](http://blog.scoutapp.com/articles/2018/01/17/tutorial-distributed-tracing-in-ruby-with-opentracing)
- [Why Factories?](https://robots.thoughtbot.com/why-factories)
- [How do Ruby & Python profilers work?](https://jvns.ca/blog/2017/12/17/how-do-ruby---python-profilers-work-/)
- [Event-Driven Microservices with RabbitMQ and Ruby](https://blog.kontena.io/event-driven-microservices-with-rabbitmq-and-ruby/)
